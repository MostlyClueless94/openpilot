...
class BluePilotLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    # Vehicle profile status/actions
    self._vehicle_profile_action = ButtonAction(lambda: tr("ACTIVE"))
    self._vehicle_profile_action.set_value(lambda: self._get_vehicle_profile_value())
    self._vehicle_profile_status = ListItem(
    ...
    self._vehicle_profile_relearn_btn = button_item(
    ...
    self._vehicle_profile_reset_btn = button_item(
    ...
    return [
      ...
      self._ui_debug_log,
      SectionHeader(tr("Vehicle Profiles")),
