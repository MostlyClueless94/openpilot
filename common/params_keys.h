...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"MCSubaruManualYieldFilteredDetectionEnabled", {PERSISTENT | BACKUP, BOOL, "1"}},
    {"MCSubaruManualYieldFullReleaseEnabled", {PERSISTENT | BACKUP, BOOL, "1"}},
    ...
    {"MCSubaruManualSteeringSoftHoldLevel", {PERSISTENT | BACKUP, INT, "0"}},
    ...
    {"MCSubaruMadsMaxSteeringAngle", {PERSISTENT | BACKUP, INT, "180"}},
    ...
    {"FordPrefRadarOverlayInfo", {PERSISTENT | BACKUP, INT, "4"}},
